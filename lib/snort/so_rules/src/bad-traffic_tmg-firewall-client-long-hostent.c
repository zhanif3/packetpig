...
alert udp $EXTERNAL_NET 53 -> $HOME_NET any (msg:"BAD-TRAFFIC TMG Firewall Client long host entry exploit attempt"; flow:to_client; content:"|00 01|"; depth:2; offset:4; reference:cve,2011-1889; reference:url,www.microsoft.com/technet/security/bulletin/MS11-040.mspx; classtype:attempted-user; sid:19187;)
*/
/*
 * Vuln Title: XXXX
 *
...
/* reference: url "www.microsoft.com/technet/security/bulletin/MS11-040.mspx"; */
static RuleReference rule19187ref2 = 
{
    "url", /* type */
    "www.microsoft.com/technet/security/bulletin/MS11-040.mspx" /* value */
};
...
int rule19187eval(void *p) {
   ...
   if (checkFlow(p, rule19187options[0]->option_u.flowFlags) > 0 ) {
      ...
      if(end_hostent - start_hostent > 256)
         return RULE_MATCH;

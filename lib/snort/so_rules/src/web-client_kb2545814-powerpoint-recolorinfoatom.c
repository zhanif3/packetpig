...
alert tcp $EXTERNAL_NET $HTTP_PORTS -> $HOME_NET any (msg:"WEB-CLIENT PowerPoint malformed RecolorInfoAtom exploit attempt"; flow:to_client,established; flowbits:isset,http.ppt; content:"|0f 00 11 f0|"; content:"|00 00 e7 0f|"; within:100; reference:cve,2011-1270; reference:url,www.microsoft.com/technet/security/bulletin/MS11-036.mspx; classtype:attempted-user; sid:18949;)
*/
/*
 * Vuln Title: XXXX
 *
...
/* reference: url "www.microsoft.com/technet/security/bulletin/MS11-036.mspx"; */
static RuleReference rule18949ref2 = 
{
    "url", /* type */
    "www.microsoft.com/technet/security/bulletin/MS11-036.mspx" /* value */
};
